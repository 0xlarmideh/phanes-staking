    ...
    <nav class="nav">
      ...
      <div>
        <ul class="buttons" :class="nightMode ? 'buttons-night' : ''">
          <li>
            <NuxtLink to="/" @click="setActive" class="btn btn1"
              >Index</NuxtLink
            >
          </li>
          <li>
  ...
  methods: {
    ...
    handleDarkMode() {
      ...
      if (this.darkMode === true) {
        ...
        this.colorVal = "rgba(7, 14, 12, 0.85)"
      }
    },
    setActive() {
      this.hideMenu = true;
...
.wrapper {
  ...
  background: linear-gradient(
    180deg,
    rgba(243, 243, 243, 0.132) 0%,
    rgba(243, 243, 243, 0.044) 100%
  );
